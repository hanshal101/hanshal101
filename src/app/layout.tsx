...
export const metadata: Metadata = {
  title: { default: "Hanshal Mehta", template: "%s • Hanshal Mehta" },
  creator: "Hanshal Mehta",
  publisher: "Hanshal Mehta",
  description: "Software Developer. Backend, Linux.",
  keywords: [
  ],
  authors: [{ name: "Hanshal Mehta", url: "https://hanshal101.github.io/hanshal101/" }],
  colorScheme: "dark light",
  openGraph: {
    title: "Hanshal Mehta",
    description: "Software Developer. Backend, Linux.",
    url: "https://hanshal101.github.io/hanshal101/",
    siteName: "Hanshal Mehta",
    images: [
      { url: "https://kunalsin9h.com/images/og.jpg", width: 1200, height: 630 },
      {
        ...
        width: 1200,
        height: 630,
        alt: 'A white background with the text "Hanshal Mehta" in the bottom left',
      },
    ],
    locale: "en-US",
    type: "website",
  ...
  twitter: {
    ...
    siteId: "hanshal101",
    creator: "@MehtaHanshal",
    creatorId: "hanshal101",
    images: {
      url: "https://kunalsin9h.com/images/og.jpg",
      alt: 'A gradient background with noise and "Hanshal Mehta" written at the bottom left',
    },
  },
  verification: {
    ...
    yahoo: "yahoo",
    other: { me: ["hanshalmehta10@gmail.com"] },
  },
  alternates: {
    canonical: "https://hanshal101.github.io/hanshal101/",
                ...
                <div className="flex items-center space-x-2">
                  <HoverTooltip
                    ...
                    child={
                      <Button variant="ghost" size="icon">
                        <a href="https://github.com/hanshal101" target="_black">
                          <svg
                            width="18"
                            height="18"
                            viewBox="0 0 15 15"
                  ...
                  <HoverTooltip
                    ...
                    child={
                      <Button variant="ghost" size="icon">
                        <a
                          href="https://twitter.com/MehtaHanshal"
                          target="_black"
                        >
                          <svg
                            width="18"
